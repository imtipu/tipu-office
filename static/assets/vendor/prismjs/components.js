var components = {
    ...
    "languages": {
        ...
        "css": {"title": "CSS", "option": "default", "peerDependencies": "markup"},
        "clike": {"title": "C-like", "option": "default", "overrideExampleHeader": true},
        "javascript": {
            "title": "JavaScript",
            "require": "clike",
        ...
        "asciidoc": {"title": "AsciiDoc", "owner": "Golmote"},
        ...
        "bash": {"title": "Bash", "owner": "zeitgeist87"},
        "basic": {"title": "BASIC", "owner": "Golmote"},
        "batch": {"title": "Batch", "alias": "shell", "owner": "Golmote"},
        ...
        "csharp": {"title": "C#", "require": "clike", "alias": "dotnet", "owner": "mvalipour"},
        "cpp": {"title": "C++", "require": "c", "owner": "zeitgeist87"},
        "coffeescript": {"title": "CoffeeScript", "require": "javascript", "owner": "R-osey"},
        ...
        "css-extras": {"title": "CSS Extras", "require": "css", "owner": "milesj"},
        ...
        "docker": {"title": "Docker", "owner": "JustinBeckwith"},
        ...
        "haskell": {"title": "Haskell", "owner": "bholst"},
        "haxe": {"title": "Haxe", "require": "clike", "owner": "Golmote"},
        "http": {"title": "HTTP", "peerDependencies": ["javascript", "markup"], "owner": "danielgtaylor"},
        ...
        "latex": {"title": "LaTeX", "owner": "japborst"},
        "less": {"title": "Less", "require": "css", "owner": "Golmote"},
        "liquid": {"title": "Liquid", "owner": "cinhtau"},
        "lisp": {"title": "Lisp", "owner": "JuanCaicedo", "alias": ["emacs", "elisp", "emacs-lisp"]},
        ...
        "markdown": {"title": "Markdown", "require": "markup", "owner": "Golmote"},
        ...
        "n4js": {"title": "N4JS", "require": "javascript", "owner": "bsmith-n4"},
        ...
        "objectivec": {"title": "Objective-C", "require": "c", "owner": "uranusjr"},
        ...
        "php": {"title": "PHP", "require": ["clike", "markup-templating"], "owner": "milesj"},
        "php-extras": {"title": "PHP Extras", "require": "php", "owner": "milesj"},
        ...
        "pure": {"title": "Pure", "peerDependencies": ["c", "cpp", "fortran", "ats", "dsp"], "owner": "Golmote"},
        "python": {"title": "Python", "owner": "multipetros"},
        "q": {"title": "Q (kdb+ database)", "owner": "Golmote"},
        "qore": {"title": "Qore", "require": "clike", "owner": "temnroegg"},
        "r": {"title": "R", "owner": "Golmote"},
        "jsx": {"title": "React JSX", "require": ["markup", "javascript"], "owner": "vkbansal"},
        ...
        "ruby": {"title": "Ruby", "require": "clike", "owner": "samflores"},
        "rust": {"title": "Rust", "owner": "Golmote"},
        "sas": {"title": "SAS", "owner": "Golmote"},
        "sass": {"title": "Sass (Sass)", "require": "css", "owner": "Golmote"},
        "scss": {"title": "Sass (Scss)", "require": "css", "owner": "MoOx"},
        ...
        "textile": {"title": "Textile", "require": "markup", "peerDependencies": "css", "owner": "Golmote"},
        ...
        "typescript": {"title": "TypeScript", "require": "javascript", "alias": "ts", "owner": "vkbansal"},
        ...
        "visual-basic": {"title": "Visual Basic", "owner": "Golmote", "alias": "vb"},
        "wasm": {"title": "WebAssembly", "owner": "Golmote"},
        "wiki": {"title": "Wiki markup", "require": "markup", "owner": "Golmote"},
        "xeora": {"title": "Xeora", "require": "markup", "owner": "freakmaxi"},
        "xojo": {"title": "Xojo (REALbasic)", "owner": "Golmote"},
        "xquery": {"title": "XQuery", "require": "markup", "owner": "Golmote"},
        "yaml": {"title": "YAML", "owner": "hason"}
    },
    "plugins": {
        "meta": {"path": "plugins/{id}/prism-{id}", "link": "plugins/{id}/"},
        "line-highlight": "Line Highlight",
        "line-numbers": {"title": "Line Numbers", "owner": "kuba-kubula"},
        "show-invisibles": "Show Invisibles",
        "autolinker": "Autolinker",
        "wpd": "WebPlatform Docs",
        "custom-class": {"title": "Custom Class", "owner": "dvkndn", "noCSS": true},
        "file-highlight": {"title": "File Highlight", "noCSS": true},
        "show-language": {"title": "Show Language", "owner": "nauzilus", "noCSS": true, "require": "toolbar"},
        "jsonp-highlight": {"title": "JSONP Highlight", "noCSS": true, "owner": "nauzilus"},
        "highlight-keywords": {"title": "Highlight Keywords", "owner": "vkbansal", "noCSS": true},
        "remove-initial-line-feed": {"title": "Remove initial line feed", "owner": "Golmote", "noCSS": true},
        "previewers": {"title": "Previewers", "owner": "Golmote"},
        "autoloader": {"title": "Autoloader", "owner": "Golmote", "noCSS": true},
        "keep-markup": {"title": "Keep Markup", "owner": "Golmote", "after": "normalize-whitespace", "noCSS": true},
        "command-line": {"title": "Command Line", "owner": "chriswells0"},
        ...
        "data-uri-highlight": {"title": "Data-URI Highlight", "owner": "Golmote", "noCSS": true},
        "toolbar": {"title": "Toolbar", "owner": "mAAdhaTTah"},
        "copy-to-clipboard": {
